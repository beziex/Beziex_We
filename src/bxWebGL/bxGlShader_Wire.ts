...
export class BxGlShader_Wire extends BxGlShader {
    ...
    public constructor(gl: WebGLRenderingContext, canvasID: string, progContainer: BxGlProgContainer, parent: BxGlMain) {
        ...
        this.programObj_ = <BxGlProgramBase>progContainer.viewProgGL3_WireObj();
    }
    ...
    protected drawMain_NonPreDiv(): void {
        ...
        const m = this.tessLevel * this.tessLevel * 5 * 2;
        instancedAry.drawElementsInstancedANGLE(this.gl_.LINES, m, this.gl_.UNSIGNED_INT, 0, this.numSurface_NonPreDiv_);
    }
    ...
    protected drawMain_PreDiv(): void {
        ...
        const m = tessCount * tessCount * 5 * 2;
        instancedAry.drawElementsInstancedANGLE(this.gl_.LINES, m, this.gl_.UNSIGNED_INT, 0, numSurface_PreDiv);
    }

    // ------

    protected genIndexAry(): number[] {
        const indexAry = new Array<number>(this.KNumTessMax * this.KNumTessMax * 5 * 2);
